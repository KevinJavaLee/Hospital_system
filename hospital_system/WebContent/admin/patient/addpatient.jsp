...
<%@ include file="../base/header.jsp" %>
  ...
  <body>
    <div class="weadmin-body">
        <form class="layui-form" action="<%=request.getContextPath() %>/admin/patient/addpatient" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="" id="tel" name="tel" required="" lay-verify="phone"
