			...
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search" action="" method="get">
					...
					<div class="layui-inline">
						<input type="text" name="likeuser" placeholder="请输入姓名" autocomplete="off" class="layui-input" />
					</div>
			...
			<table class="layui-table" id="memberList">
				...
				<c:forEach items="${userList }" var="item" varStatus="i">
					<tr data-id="item.count">
						...
						<td>${item.age }</td>
						<td class="td-status">
							<span class="layui-btn layui-btn-normal layui-btn-xs"><c:out value="${item.sex }" default="未设置"></c:out></span>
						</td>
						<td class="td-manage">
