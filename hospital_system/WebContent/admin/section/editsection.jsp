...
<%@ include file="../base/header.jsp" %>
  ...
  <body>
    <div class="weadmin-body">
        <form class="layui-form" action="<%=request.getContextPath() %>/admin/section/editsection?id=${section.s_id}" method="post" >
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="we-red">*</span>科室名
              </label>
              <div class="layui-input-inline">
                  <input type="text" value="${section.s_name }" name="sectionname" required="" lay-verify="required"
                  autocomplete="off" value="" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="we-red">*</span>科室的名字
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="${section.specialty }" name="specialty" required="" lay-verify="required"
                  autocomplete="off" value="" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
          ...
          <textarea name="content" value="${section.s_brief }" id="content" cols="60" rows="10"></textarea>
          <div class="layui-form-item">
