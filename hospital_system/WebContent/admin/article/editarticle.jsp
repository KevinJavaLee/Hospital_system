...
<%@ include file="../base/header.jsp" %>
  ...
  <body>
    <div class="weadmin-body">
        <form class="layui-form" action="<%=request.getContextPath() %>/admin/article/editarticle?id=${article.a_id}" method="post" enctype="multipart/form-data">
          <!-- <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="we-red">*</span>文章ID
              </label>
              ...
              <div class="layui-form-mid layui-word-aux">
                  <span class="we-red">*</span>文章的唯一ID
              </div>
          </div> -->
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" value="${article.a_title }" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" value="${article.a_author }" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" value="${article.a_titleimg }">
              </div>
          ...
          <textarea name="content" value="${article.a_content }" id="content" cols="60" rows="20"></textarea>
          <div class="layui-form-item">
