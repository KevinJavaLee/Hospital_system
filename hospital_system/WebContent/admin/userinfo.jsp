...
<%@ include file="base/header.jsp" %>
  ...
  <body>
    <div class="weadmin-body">
        <form class="layui-form" action="<%=request.getContextPath() %>/admin/userinfo" method="post" enctype="multipart/form-data">
          ...
          <div class="layui-form-item layui-form-text">
    		...
    		<div class="layui-input-block">
      			<textarea name="brief" placeholder="" value="" class="layui-textarea" >${user.brief}</textarea>
    		</div>
  		 </div>
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-block">
              	<c:if test="${user.userType == 'admin'}">
              		<input type="radio" name="userType" value="admin" lay-skin="primary" title="超级管理员" checked="">
              	...
              	<c:if test="${user.userType =='doctor' }">
                	...
                	<input type="radio" name="userType" value="doctor" lay-skin="primary" title="医生"checked="">
