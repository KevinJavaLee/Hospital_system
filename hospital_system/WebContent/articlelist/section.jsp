...
<div class="header header_k clearfix">
    <span class="suoyin"><a href="../../Index.html">首页</a> - <a href="../index.html" title="新闻中心" target="_self">新闻中心</a> - <a href="Index.html" title="医院新闻" target="_self">医院新闻</a></span>
    ...
    <div class="web_mainbox">
        <div class="web_left">
            ...
            <div class="art_box_c">
                ...
                <h1>${section.s_name}</h1>
                 <div class="remark">专长：${section.specialty}　　${section.s_time }  所属科：${section.s_type }</div>
