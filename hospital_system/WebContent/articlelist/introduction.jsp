...
<div class="nav nav_k">
	...
	<li class="nav-item">
		<div class="nav-item-tit" id="nav_yyjs"><a href="" target="_self">医院介绍</a></div>
			<ul class="nav-item-list">
				<li><a href="" target="_self">医院简介</a></li>
			</ul>
	</li>
	...
	<li class="nav-item">
		...
		<ul class="nav-item-list">
			<li><a href="../articlelistpage" target="_self">医院新闻</a></li>
	...
	<li class="nav-item">
		...
		<ul class="nav-item-list">
			   <li><a href="http://localhost:8888/hospital_system/pages/echarts/templates/main1.html">河北疫情图</a></li>
		</ul>
	</li>
    </ul>
</div>
        ...
        <div class="web_left">
            ...
            <div class="art_box_c">
                ...
                <h1>${introduction.title}</h1>
                 <div class="remark">作者：${introduction.author}　　${introduction.time }  </div>
                <div class="digest"><cite></cite></div> 
                <div class="art_con">
