...
function get_c1_data() {
	$.ajax({
        url: "http://localhost:8888/hospital_system/sendtable",
		type:"GET",
		success: function(data) {
            // console.log(data);
...
function get_c2_data() {
    $.ajax({
		url:"http://localhost:8888/hospital_system/senddatacenter",
		method:"Get",
		dataType: "JSON",
        success: function(data) {
			console.log(data);
...
function get_r1_data() {
    $.ajax({
		url: "http://localhost:8888/hospital_system/sendtopdata",
		method:"Get",
		dataType:"json",
        success: function (data) {
			var confirmedNumArr = [];
