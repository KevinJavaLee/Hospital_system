...
/**
 * Servlet implementation class SortedData
 */
@WebServlet("/spider/SortedData")
public class SortedData extends HttpServlet {
...
//		response.getWriter().println("匡总牛逼！");
//		
		String sqlString ="select * from urban where cid = 13 order by confirmedNum desc ";
